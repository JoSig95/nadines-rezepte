...
9. Alle Rezeptkarten verwenden dieselbe gut lesbare Standardschriftgröße; die Schrift für umfangreiche Rezepte nicht verkleinern. Zunächst prüfen, ob das Rezept auf eine DIN-A5-Seite passt. Bei langen Rezepten Formulierungen kürzen und Abstände moderat anpassen; keine Zutaten oder Arbeitsschritte entfernen. Reicht eine Seite mit der Standardschrift nicht aus, das Rezept mit `cardPages: 2` auf zwei DIN-A5-Karten aufteilen: Titel, Bild und Zutaten auf Karte 1, Zubereitung und Tipp auf Karte 2.
